        ...
        <div class="image-group">
            ...
            <div class="image-upload-area">
                <input
                    ...
                    class="d-none"
                >
                <div v-if="!featuredImagePreview" class="upload-placeholder" @click="$refs.featuredImageInput.click()">
                    <i class="bi bi-cloud-upload"></i>
                    <p>Haz clic para subir imagen destacada</p>
                    <small>JPG, PNG, WebP - Máximo 5MB</small>
                </div>
                <div v-else class="image-preview">
                    <img :src="featuredImagePreview" alt="Imagen destacada" class="preview-img">
        ...
        <div class="image-group">
            ...
            <div class="gallery-upload-area">
                ...
                <div class="upload-placeholder" @click="$refs.galleryImagesInput.click()">
                    ...
                    <p>Agregar imágenes a la galería</p>
                    <small>Puedes seleccionar múltiples imágenes</small>
                </div>
                
                <div v-if="galleryPreviews.length > 0" class="gallery-previews">
                    <div v-for="(preview, index) in galleryPreviews" :key="index" class="gallery-item">
                        <img :src="preview.url" :alt="`Galería ${index + 1}`" class="gallery-img">
                        <button type="button" @click="removeGalleryImage(index)" class="btn btn-sm btn-danger remove-btn">
                            <i class="bi bi-x"></i>
                        </button>
                    </div>
                </div>
...
const emit = defineEmits(['update:featuredImage', 'update:galleryImages']);
